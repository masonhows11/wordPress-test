        ...
        <form action="" method="post">
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td><input type="checkbox" name="is_login_active"></td>
                </tr>
                <tr valign="top">
                    <th scope="row">فعال بودن ثبت نام</th>
                    <td><input type="checkbox" name="is_register_active"></td>
                </tr>

                <tr valign="top">
                    <th scope="row">عنوان فرم ورود</th>
                    <td><input type="text" name="login_title_form"></td>
                </tr>
                <tr valign="top">
                    <th scope="row">عنوان فرم ثبت نام</th>
                    <td><input type="text" name="register_title_form"></td>
                </tr>
                <tr valign="top">
