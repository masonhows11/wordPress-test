<div class="col-lg-8">
    <div class="blog-post">
        ...
        <h3 class=""><a href="#">کلید آلیشیا در سفرهای طولانی زندگی در مصر است</a></h3>
    ...
    <div class="blog-post">
        <a href="#"><img class="rounded mb-lg-5 mb-4" src="<?php echo CLAB_URL; ?>assets/img/blog/b2.jpg" alt="card image" /></a>
        <h3 class=""><a href="#">کلید آلیشیا در سفرهای طولانی زندگی در مصر است</a></h3>
        <div class="meta font-lora my-4">
            <a href="#">سفر کردن</a>
            <span class="meta-separator"></span>
    ...
    <div class="blog-post">
        <div class="position-relative mb-lg-5 mb-4">
            <img class="rounded" src="<?php echo CLAB_URL; ?>assets/img/blog/b3.jpg" alt="">
