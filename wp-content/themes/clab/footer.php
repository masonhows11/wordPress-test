...
<!--basic scripts-->
<script src="<?php  echo CLAB_URL; ?>assets/vendor/jquery/jquery.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/popper.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/vl-nav/js/vl-menu.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/owl/owl.carousel.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/jquery.animateNumber.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/jquery.countdown.min.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/typist.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/jquery.isotope.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/imagesloaded.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/visible.js"></script>
<script src="<?php  echo CLAB_URL; ?>assets/vendor/wow.min.js"></script>

<!--basic scripts initialization-->
<script src="<?php  echo CLAB_URL; ?>assets/js/scripts.js"></script>
